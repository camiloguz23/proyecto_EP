...
<body>
    ...
    <a href="#" class="button2"> <img class="butuno" height="30" width="30" src="../imagenes/Imagen9.png" alt="" srcset=""> LEGALIZACIÓN</a>
    <a href="#" class="button3"> <img class="butdos" height="30" width="30" src="../imagenes/Imagen5.png" alt="" srcset="">CERTIFICACIÓN</a>
        ...
        <div class="informa2">
            <div class="buscador2">
                ...
                <form method="POST" id="buscarDocu" name="buscarDocu" class="buscarDocu" autocomplete="off">
                    ...
                    <div class="boton2">
                        <a href="" id= "boton2"><img class= "boton2" src="../imagenes/Imagen3.png" height="50px" width="50px" ></a>
                    </div>
                </form>
            </div>
        </div>
